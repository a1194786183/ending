...
public class PasswordEncoder {
    ...
    public static void main(String[] args) {
        ...
        boolean passwordValid = encoderMd5.matches("fd80ebd493a655608dc893a9f897d845", "test");
        System.out.println(passwordValid);

        PasswordEncoder encoderSha = new PasswordEncoder(salt, "SHA");
        String pass2 = encoderSha.encode("admin");
        System.out.println(pass2);
        boolean passwordValid2 = encoderSha.matches("bd1718f058d8a02468134432b8656a86", "admin");
